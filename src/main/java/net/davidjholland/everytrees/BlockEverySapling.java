...
public class BlockEverySapling extends BlockBush implements IGrowable
{
    public static final String[] field_149882_a = new String[] {"diamond", "gold", "iron", "emerald", "lapis", "glowstone", "redstone"};
    private static final IIcon[] field_149881_b = new IIcon[field_149882_a.length];

    protected BlockEverySapling()
    {
    ...
    {
        p_149691_2_ &= 7;
        return field_149881_b[MathHelper.clamp_int(p_149691_2_, 0, 6)];
    }
    ...
    public void func_149878_d(World p_149878_1_, int p_149878_2_, int p_149878_3_, int p_149878_4_, Random p_149878_5_)
    {
        ...
        // Tree Configuration
     	object = new WorldGenEveryTrees(true, 5, l, l, false);
    ...
    {
        return MathHelper.clamp_int(p_149692_1_ & 7, 0, 6);
    }
    ...
    {    	
        ...
        {
            field_149881_b[i] = p_149651_1_.registerIcon(EveryTrees.MODID + ":" + this.getTextureName() + "_" + field_149882_a[i]);
        }
    }
