...
public class ETCrafting {
	...
	private static void addCraftingRecipes() {
		...
		GameRegistry.addRecipe(new ItemStack(ETCBlocks.saplings, 1, 7), new Object[]{
	    	...
	    	"XOX",
	    	"XXX",
	    	'X', Blocks.coal_block, 'O', Blocks.sapling
		});
		// Enchanted
		GameRegistry.addRecipe(new ItemStack(ETCBlocks.saplings, 1, 8), new Object[]{
	    	...
	    	"DSD",
	    	"ODO",
	    	'S', Blocks.sapling, 'D', new ItemStack(ETCItems.shards, 1, 0), 'O', new ItemStack(ETCItems.shards, 1, 1)
		});
		// Ender
		...
		GameRegistry.addRecipe(new ItemStack(Items.emerald), new Object[]{
	    	...
	    	"XXX",
	    	"XXX",
	    	'X', new ItemStack(ETCItems.shards, 1, 0)
		});
		// Diamond
		GameRegistry.addRecipe(new ItemStack(Items.diamond), new Object[]{
	    	...
	    	"XXX",
	    	"XXX",
	    	'X', new ItemStack(ETCItems.shards, 1, 1)
		});
		// Obsidian
		GameRegistry.addRecipe(new ItemStack(Blocks.obsidian), new Object[]{
	    	...
	    	"XXX",
	    	"XXX",
	    	'X', new ItemStack(ETCItems.shards, 1, 2)
		});
	}
